...
const fullPathData =
  "m775,305.4h-286.94L400,37.74l-88.06,267.66H25l234.7,164.69-91.41,267.66,231.7-165.88,231.7,165.88-91.58-267.66,234.88-164.69Z";
const halfStarPathData =
  "m400,407.9V37.74l-88.06,267.66H25l234.7,164.69-91.41,267.66,231.7-165.88h0v-163.97Z";
const quarterStarPathData =
  "m311.94,305.4H25l234.7,164.69-91.41,267.66,231.7-165.88h0l-88.06-266.47h0Z";
const threeQuarterStarPathData =
  "m775,305.4h-286.94L400,37.74l-88.06,267.66H25l234.7,164.69-91.41,267.66,231.7-165.88,140.12-101.78h0l234.88-164.69Z";
...
function moveObjectOnMouseOver(svg, svgWidth, svgHeight, dataPoint) {
  ...
  book.transition().attr("transform", "translate(" + this.width / 3 + ", 0)");
